...
export const NODES = {
  ...
  s1: {
    ...
    info: {
      ...
      attrs: [
        '1-Week Sprint: Diverge-and-converge cycles informed by Google Sprint Methodology (5-day structure) — AI generates multiple distinct directions for a single brief, explored and tested within one week',
